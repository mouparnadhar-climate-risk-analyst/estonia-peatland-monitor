...
def authenticate_gee():
    ...
    Works for both Hugging Face and Streamlit Cloud.
    """
    try:
        # 1. Get the secret string (Hugging Face uses os.environ)
        ...
        # 2. Decode the Base64 string into normal text
        decoded_key = base64.b64decode(encoded_key).decode("utf-8")

        # 3. Force-create the credentials file exactly where GEE expects it
        ...
        # 4. Initialize! (GEE will automatically find the file we just created)
